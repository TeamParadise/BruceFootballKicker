...
import net.pvschools.robotics.javabot.practice.commands.ActuallyKickFootball;
import net.pvschools.robotics.javabot.practice.commands.ChargeKicker;
import net.pvschools.robotics.javabot.practice.commands.FootballKicker;
...
public class OI
{
    ...
    private OI()
    {
		...
		SmartDashboard.putData(new FootballKicker());
		SmartDashboard.putData(new ActuallyKickFootball());
        ...
        mainButton4.whenPressed(new FootballKicker());
        secondaryButton4.whenPressed(new FootballKicker());
